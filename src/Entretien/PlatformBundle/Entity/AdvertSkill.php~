<?php
// src/Entretien/PlatformBundle/Entity/AdvertSkill.php
...
/**
 * @ORM\Entity
 * @ORM\Table(name="Entretien_advert_skill")
 */
class AdvertSkill
{
  /**
  ...
  /**
   * @ORM\ManyToOne(targetEntity="Entretien\PlatformBundle\Entity\Skill")
   * @ORM\JoinColumn(nullable=false)
   */
  private $skill;
